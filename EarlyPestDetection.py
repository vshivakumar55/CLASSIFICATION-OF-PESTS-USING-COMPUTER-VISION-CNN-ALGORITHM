...
main = tkinter.Tk()
main.title("Classification of Pests using Computer Vision CNN Algorithm") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Classification of Pests using Computer Vision CNN Algorithm', justify=LEFT)
